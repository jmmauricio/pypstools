...
print('time map2: {:f}'.format(time.time()-time0))
time0 = time.time()
...
print('time map3: {:f}'.format(time.time()-time0))
time0 = time.time()
...
print('time isos: {:f}'.format(time.time()-time0))
time0 = time.time()
...
for m,ax in zip(maps, axes):
    ...
    states = ['AR.JY','AR.SA','AR.CT','CL.TA','CL.AT','CL.AN','CL.']  
    states = ['CL.']  
    ...
    print('time states: {:f}'.format(time.time()-time0))
    time0 = time.time() 
    ...
    print('time countries: {:f}'.format(time.time()-time0))
    time0 = time.time()    
...
print('time subs and lines: {:f}'.format(time.time()-time0))
time0 = time.time()                
