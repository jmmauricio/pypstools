...
u'Chuquicamata S/E AA 100': {'coordinates': [-68.918674247368415, -22.304824826315791]},
 ...
 u'Tocopilla TG3': {'coordinates': [-70.192130233333344, -20.806507299999996]}, u'Crucero 220 B1': {'coordinates': [-69.56765656666667, -22.276635033333335]}, u'Esmeralda Uribe 23': {'coordinates': [-70.420201279999986, -23.714600699999998]}, 
 ...
 u'Crucero 220': {'coordinates': [-69.56765656666667, -22.276635033333335]}, u'S/E Tap Off Barriles 220 kV': {'coordinates': [-69.77449956000001, -20.257194300000002]}, 
...
# channels for buses
for bus_name in buses_names:
    
    obj = app.GetCalcRelevantObjects("{:s}.ElmTerm".format(bus_name) )
    if len(obj)>0:
        bus=obj[0]

        if bus_name.find('220')>0:
            print(bus_name)
...
comres.f_name = r'E:\Documents\public\workspace\pypstools\tests\sing_results.txt'  # change 'C:\Users\jmmauricio\hola.txt' with your path
comres.iopt_exp=4
comres.Execute()
